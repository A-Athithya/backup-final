...
// Doctors
Route::get('doctors', 'DoctorController@index', ['AuthMiddleware', 'RoleMiddleware:admin,provider,doctor,nurse']);
Route::get('doctors/{id}', 'DoctorController@show', ['AuthMiddleware', 'RoleMiddleware:admin,provider,doctor,nurse']);
...
// Patient Management
Route::get('patients', 'PatientController@index', ['AuthMiddleware', 'RoleMiddleware:admin,provider,doctor,nurse']);
Route::get('patients/{id}', 'PatientController@show', ['AuthMiddleware', 'RoleMiddleware:admin,provider,doctor,nurse']);
Route::post('patients', 'PatientController@store', ['AuthMiddleware', 'CsrfMiddleware', 'RoleMiddleware:admin,provider,doctor,nurse']);
Route::put('patients/{id}', 'PatientController@update', ['AuthMiddleware', 'CsrfMiddleware', 'RoleMiddleware:admin,provider,doctor,nurse']);
Route::delete('patients/{id}', 'PatientController@delete', ['AuthMiddleware', 'CsrfMiddleware', 'RoleMiddleware:admin']);
Route::get('patients/{id}/appointments', 'PatientController@appointments', ['AuthMiddleware', 'RoleMiddleware:admin,provider,doctor,nurse']);

// Appointment Management
Route::get('appointments', 'AppointmentController@index', ['AuthMiddleware', 'RoleMiddleware:admin,provider,doctor,nurse,patient']);
Route::get('appointments/upcoming', 'AppointmentController@upcoming', ['AuthMiddleware', 'RoleMiddleware:admin,provider,doctor,nurse,patient']);
...
Route::get('appointments/{id}', 'AppointmentController@show', ['AuthMiddleware', 'RoleMiddleware:admin,provider,doctor,nurse,patient']);
...
Route::post('appointments', 'AppointmentController@store', ['AuthMiddleware', 'CsrfMiddleware', 'RoleMiddleware:admin,provider,doctor,patient']);
Route::put('appointments/{id}', 'AppointmentController@update', ['AuthMiddleware', 'CsrfMiddleware', 'RoleMiddleware:admin,provider,doctor,nurse,patient']);
Route::delete('appointments/{id}', 'AppointmentController@delete', ['AuthMiddleware', 'CsrfMiddleware', 'RoleMiddleware:admin,provider,doctor,nurse,patient']);
...
// Billing
Route::get('billing', 'BillingController@index', ['AuthMiddleware', 'RoleMiddleware:admin,provider,doctor']);
...
Route::post('billing', 'BillingController@store', ['AuthMiddleware', 'CsrfMiddleware', 'RoleMiddleware:admin,provider,doctor']);
